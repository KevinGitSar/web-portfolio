    ...
    return(
        <div>
            ...
            <div className="w-full bg-white">
                <div className="fixed border border-[#3FAA95] w-[60px] sm:w-[65px] md:w-[80px] lg:w-[85px] xl:w-[90px] 2xl:w-[100px] m-3 cursor-pointer z-10 transition ease-in-out delay-100 hover:scale-105" onClick={()=>{toggleMenu()}}>
                    <img src="/icons/ks-logo.png" />
                </div>
                <div className={menu ? 'fixed w-full h-full bg-[#1D2233] bg-opacity-50 delay-500' : 'fixed w-full h-full bg-[#1D2233] delay-100 -translate-x-full'} onClick={()=>{toggleMenu()}}>
                    <div className={menu ? 'fixed w-1/2 md:w-1/3 lg:w-1/5 h-full bg-[#1D2233] transition ease-in-out delay-500' : 'fixed w-1/2 md:w-1/3 lg:w-1/5 h-full bg-[#1D2233] transition ease-in-out delay-500 -translate-x-full'}>
